        ...
        <StyledContent>
          <StyledColumns>
            ...
            <MediumSpace className="faq">
              ...
              <p><a className="showNextLink" onClick={showNextDiv}>How did this all start?</a></p>
