...
import { StyledContent, Heading, FullSection, MediumSpace, StyledColumns } from '../../styles/PageStyles'
    ...
    <>
        ...
        <StyledContent>
          <StyledColumns>
            ...
            <MediumSpace className="faq">
              ...
              <p><a className="showNextLink" onClick={showNextDiv}>I’m a student, how do I find my Lesson?</a></p>
              <div className="hidden"><p>If you’re a student enrolled in a Lesson, login to RapGuide.com and enter the access code sent to you by your teacher using the code field at the top of the Lessons page, and your assignment should appear.</p>
                <SocialShare
                  url="https://www.rapguide.com/about#faq"
              ...
              <p><a className="showNextLink" onClick={showNextDiv}>I’m a teacher, how do I make a Lesson?</a></p>
              <div className="hidden"><p>Contact us to request an Educator Account and you will see the “Create a Lesson” button next to each video. You can either write your assignment from scratch or adapt one of the existing lesson templates shared by other teachers. Once you’ve selected which lyrics to assign as annotatable, written your instructions and an example annotation, and set the deadline and the number of annotations, upvotes, and comments required per student to complete the assignment, you will see the Lesson appear in your Dashboard and a code generator to share it with students.</p>
                <SocialShare
                  url="https://www.rapguide.com/about#faq"
      ...
      <FullSection id="faq-2" style={{ display: "flex", alignItems: "center" }}>
        <StyledContent>
          <StyledColumns>
            <MediumSpace className="faq">
              <p><a className="showNextLink" onClick={showNextDiv}>Why can’t I see my annotations publicly?</a></p>
              <div className="hidden"><p>We are assessing annotations in consultation with expert consultants and publishing them as fast as we can, so please stay tuned. Not all annotations generated by Lessons will be published, but if your annotation is selected for display you will receive a notification and a link to share it on social media.</p>
                <SocialShare
              ...
              <p><a className="showNextLink" onClick={showNextDiv}>Can the public annotate the lyrics if they want to?</a></p>
              <div className="hidden"><p>We might add public annotations at some point in the future, but for now annotations must be generated by students in a Lesson, or by invited educators or experts.</p>
                <SocialShare
                  url="https://www.rapguide.com/about#faq-2"
              ...
              <p><a className="showNextLink" onClick={showNextDiv}>How much does this cost?</a></p>
              <div className="hidden"><p>This site is in beta mode and currently free. It will always be free for students and the public, and many of the functions will remain free for most teachers. At some point in the future we will probably add a subscription service for educators to unlock premium features of the site.</p>
                <SocialShare
                  url="https://www.rapguide.com/about#faq-2"
              ...
              <p><a className="showNextLink" onClick={showNextDiv}>Who pays for Rap Guides to get made?</a></p>
              <div className="hidden"><p>Most of Baba Brinkman’s songs and videos were either paid for by crowdfunding, including Kickstarter, IndieGogo, and Patreon, or commissioned and paid for by sponsors eager to speed up the process of getting a Rap Guide to a certain topic made. If topics submitted via the Request page gain a lot of public interest (and don’t attract a sponsor), we may add a crowdfunding function at some point to help cover production costs.</p>
                <SocialShare
                  url="https://www.rapguide.com/about#faq-2"
              ...
              <p><a className="showNextLink" onClick={showNextDiv}>Who makes Rap Guide videos?</a></p>
              <div className="hidden"><p>Baba Brinkman (with help from Mark Pallen) coined the phrase and has made the most content under the “Rap Guide” banner, but lots of other artists make songs and videos with informative content (<Link to="/playlist/rap-guide-mixtape">you can see a few examples here</Link>), and this site is set up so that any video by any artist can be added (with the artist’s permission). Teachers, if you know of a music video made by someone other than Baba Brinkman that you’d like to use for a class assignment, please contact us and we’ll try to get permission to add it.</p>
                <SocialShare
                  url="https://www.rapguide.com/about#faq-2"
              ...
              <p><a className="showNextLink" onClick={showNextDiv}>Who are these Rap Guides for?</a></p>
              <div className="hidden"><p>The public! RapGuide.com showcases videos that are made for general entertainment, and which also happen to contain useful content for teachers. Feel free to browse and enjoy videos on this site, and at any point if you want to take a deep dive into the science, go ahead and read the annotations and follow their source links.</p>
                <SocialShare
                  url="https://www.rapguide.com/about#faq-2"
