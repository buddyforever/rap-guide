        ...
        <StyledContent>
          <StyledColumns>
            <MediumSpace className="faq">
              ...
              <div className="hidden"><p>Baba Brinkman (with help from Mark Pallen) coined the phrase and has made the most content under the “Rap Guide” banner, but lots of other artists make songs and videos with informative content (<a href="https://www.youtube.com/playlist?list=PLuHbMGCLLUYZKXqlLHxOFKHcKOXAp-Fvz">you can see a few examples here</a>), and this site is set up so that any video by any artist can be added (with the artist’s permission). Teachers, if you know of a music video made by someone other than Baba Brinkman that you’d like to use for a class assignment, please contact us and we’ll try to get permission to add it.</p></div>
