...
import { CREATE_GUIDE, PUBLISH_GUIDE } from '../../queries/guides'
import { GET_ALL_TOPICS, CREATE_TOPIC, PUBLISH_TOPIC } from '../../queries/topics'
...
export const AddGuide = () => {
  ...
  const [publishGuide] = useMutation(PUBLISH_GUIDE)
  const [createTopic] = useMutation(CREATE_TOPIC)
  const [publishTopic] = useMutation(PUBLISH_TOPIC)
